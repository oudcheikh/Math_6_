        ...
        <Container>
            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        <img src={"/images/Français/grammaire/Conjonction/coordination/conjonction.png"} alt="Teacher" />
                    </ImageContainer>
                </SectionContainer>
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/coordination/chocolat.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <br></br>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/coordination/thé.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/coordination/travel.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/coordination/.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/coordination/pluit.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
