        ...
        <Container>
            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        <img src={"/images/Français/grammaire/Conjonction/conjSub/prof.jpg"} alt="Teacher" />
                    </ImageContainer>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/conjSub/fatigué.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/conjSub/dispo.png"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/conjSub/argents.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/conjSub/travail.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Conjonction/conjSub/attendre.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
