     ...
     <button  className="boutonVert" onClick={handleClick}>Exercices</button>
            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        <img src={"images/Français/grammaire/Préposition/prof.jpg"} alt="Teacher" />
                    </ImageContainer>
                </SectionContainer>
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"images/Français/grammaire/Préposition/eleve.png"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <br></br>
                        <ImageContainer>
                            <img src={"images/Français/grammaire/Préposition/travel.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"images/Français/grammaire/Préposition/chat.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"images/Français/grammaire/Préposition/sujet.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"images/Français/grammaire/Préposition/cadeaux.jpg"} alt="cadeaux" />
                        </ImageContainer>
                        <Card>
