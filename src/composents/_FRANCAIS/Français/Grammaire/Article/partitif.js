            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        ...
                        <img src={"/images/Français/grammaire/IMArticle/prof.jpg"} alt="Teacher" />
                    </ImageContainer>
                </SectionContainer>

               <SectionContainer>
               <ImageContainer>
                        <img src={"/images/Français/grammaire/IMArticle/pain.jpg"} alt="Teacher" />
                    </ImageContainer>
                ...
                <SectionContainer>
               <ImageContainer>
                        <img src={"/images/Français/grammaire/IMArticle/limonade.jpg"} alt="voiture" />
                    </ImageContainer>
                ...
                <SectionContainer>
               <ImageContainer>
                        <img src={"/images/Français/grammaire/IMArticle/etudiant.jpg"} alt="voiture" />
                    </ImageContainer>
