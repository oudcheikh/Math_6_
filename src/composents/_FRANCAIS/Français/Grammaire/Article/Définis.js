    ...
    return (
        <Container>
            ...
            {showSections[0] && (
               ...
               <SectionContainer>
               <ImageContainer>
                        <img src={"/images/Français/grammaire/IMArticle/tapis.jpg"} alt="Teacher" />
                    </ImageContainer>
                ...
                <SectionContainer>
               <ImageContainer>
                        <img src={"/images/Français/grammaire/IMArticle/voiture.jpg"} alt="voiture" />
                    </ImageContainer>
                ...
                <SectionContainer>
               <ImageContainer>
                        <img src={"/images/Français/grammaire/IMArticle/ecoute.jpg"} alt="voiture" />
                    </ImageContainer>
