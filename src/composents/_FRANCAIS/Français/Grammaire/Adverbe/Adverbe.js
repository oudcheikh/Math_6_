...
<button  className="boutonVert" onClick={handleClick}>Exercices</button>
            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        <img src={"/images/Français/grammaire/IMAdverbe/prof.jpg"} alt="Teacher" />
                    </ImageContainer>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/IMAdverbe/rapide.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/IMAdverbe/chante.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/IMAdverbe/loin.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/IMAdverbe/tard.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/IMAdverbe/travail.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
