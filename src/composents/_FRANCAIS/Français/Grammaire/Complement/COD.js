        ...
        <Container>
            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        <img src={"/images/Français/grammaire/Complement/IMComplément/prof.jpg"} alt="Teacher" />
                    </ImageContainer>
                    ...
                    <SectionContainer>
                        ...
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/IMComplément/chocolat.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/IMComplément/livre.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/IMComplément/voiture.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/IMComplément/tel.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        ...
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/IMComplément/personne.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
