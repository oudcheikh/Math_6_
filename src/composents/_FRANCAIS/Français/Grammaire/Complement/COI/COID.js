        ...
        <Container>
            ...
            {showSections[0] && (
                <><SectionContainer>
                    ...
                    <ImageContainer>
                        <img src={"/images/Français/grammaire/Complement/COImage/prof.jpg"} alt="Teacher" />
                    </ImageContainer>
                </SectionContainer>
                    <SectionContainer>

                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/COImage/cadeaux.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/COImage/livre.png"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/COImage/lettre.jpg"} alt="Teacher" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/COImage/fleur.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
                    ...
                    <SectionContainer>
                        <ImageContainer>
                            <img src={"/images/Français/grammaire/Complement/COImage/question.jpg"} alt="oiseaux" />
                        </ImageContainer>
                        <Card>
