...
// import Desert from '../imagesSience/Desert.png';
// import Desert2 from '../imagesSience/Desert2.png';
// import Kiddesert from '../imagesSience/Kiddesert.png';
// import plant from '../imagesSience/plant.png';
// import peace from '../imagesSience/peace.png';
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 3 : La Desertification</strong></FormulaText>
                  ...
                  <img src={"/images/imagesSience/Desert.png"} alt="Teacher" style={imageStyle} /> 
                  <Card>
            ...
            {section >= 1 && (
                <div>
                    ...
                    <br></br>           
 <Card>
 <img src={"/images/imagesSience/Desert2.png"} alt="Desert2"  style={{ ...imageStyle, width: '220%' }} /> 
...
{section >= 2 && (
                <div>
                    ...
                    <img src={"/images/imagesSience/Kiddesert.png"} alt="Kiddesert" style={imageStyle} /> <FormulaText>
...
<Card>  <FormulaText><strong>Lutter contre la desertification</strong></FormulaText>    
                        <img src={"/images/imagesSience/peace.png"} alt="peace" style={imageStyle} /> 
                    <FormulaText>
...
<div style={{ display: "flex", alignItems: "center" }}>
  <Audio/>
    ...
    <img src={"/images/imagesSience/plant.png"} alt="plant" style={imageStyle} /> 
    <FormulaText>
