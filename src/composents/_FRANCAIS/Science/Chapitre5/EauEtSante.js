...
// import dysenterie from '../imagesSience/dysenterie.png';
// import EauEtSante from '../imagesSience/EauEtSante.png';
// import Paludisme from '../imagesSience/Paludisme.png';
// import parasites from  '../imagesSience/parasites.png';
// import Guinea from '../imagesSience/Guinea.png';
// import bilharziose from '../imagesSience/bilharziose.png';
// import inestine from '../imagesSience/inestine.png';
import Audio from "./Audio1" ;
import {
  Container,FormulaText, Card, FormulaBox,BodyText,Subtitle, ContinueButton
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 5 : L'eau et la Santé</strong></FormulaText>
                  ...
                  <img src={"/images/imagesSience/EauEtSante.png"} alt="EauEtSante" style={imageStyle} /> 
                  <Card>
            ...
            {section >= 1 && (
                <div>
                    ...
                    <br></br>           
 <Card>
 <img src={"/images/imagesSience/inestine.png"} alt="inestine" style={imageStyle} /> 
 <FormulaText>
...
{section >= 2 && (
        ...
        <strong> 1. La diarrhée (dysenterie) </strong> </FormulaText>
                    <br></br>
                    <img src={"/images/imagesSience/dysenterie.png"} alt="dysenterie" style={imageStyle} /> 
                    <FormulaText>
...
<Card>  <FormulaText> <strong>2. Les parasitoses intestinales </strong></FormulaText>    
                        <img src={"/images/imagesSience/parasites.png"} alt="parasites" style={imageStyle} /> 
                        <FormulaText>
...
<div style={{ display: "flex", alignItems: "center" }}>
  <Audio/>
    ...
    <img src={"/images/imagesSience/Guinea.png"} alt="Guinea" style={imageStyle} /> 
    <FormulaText>
  ...
  <Audio/>
    ...
    <img src={"/images/imagesSience/bilharziose.png"} alt="bilharziose" style={imageStyle} /> 
    <FormulaText>
 ...
 {section >= 6 && (
    ...
    <img src={"/images/imagesSience/Paludisme.png"} alt="Paludisme" style={imageStyle} /> 
    <FormulaText>
