...
// import biodegradable from '../imagesSience/biodegradable.png';
// import Pollution from '../imagesSience/Pollution.png';
// import Recyclage from '../imagesSience/Recyclage.png';
// import DechargeSauvage from  '../imagesSience/DechargeSauvage.png';
// import Environement from '../imagesSience/Environement.png';
// import Polluer from '../imagesSience/Polluer.png';
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 4 : La Pollution </strong></FormulaText>
                  ...
                  <img src={"/images/imagesSience/Pollution.png"} alt="Pollution.png" style={imageStyle} /> 
                  <Card>
...
{section >= 2 && (
        ...
        <FormulaText>
                    ...
                    <br></br>
                    <img src={"/images/imagesSience/biodegradable.png"} alt="biodegradable" style={imageStyle} /> 
...
<Card>  <FormulaText><strong>Décharge sauvage</strong></FormulaText>    
                        <img src={"/images/imagesSience/DechargeSauvage.png"} alt="gluDechargeSauvagecides" style={imageStyle} /> 
                        <FormulaText>
...
<div style={{ display: "flex", alignItems: "center" }}>
  <Audio/>
    ...
    <img src={"/images/imagesSience/Environement.png"} alt="environnement" style={imageStyle} /> 
    <FormulaText>
  ...
  <Audio/>
    ...
    <img src={"/images/imagesSience/Polluer.png"} alt="Polluer" style={imageStyle} /> 
    <FormulaText>
 ...
 {section >= 6 && (
    ...
    <img src={"/images/imagesSience/Recyclage.png"} alt="Recyclage" style={imageStyle} /> 
    <FormulaText>
