...
// import Vac from '../imagesSience/Vac.png';
...
// import Protegemaladie from '../imagesSience/Protegemaladie.png';
     ...
     et à combattre les microbes sans tomber malade. C'est comme si on entraînait nos défenses pour être super fortes !
            ...
            {section >= 1 && (
                <div>
                    ...
                    <br></br>           
 <Card>
 <img src={"/images/imagesSience/Protegemaladie.png"} alt="Protegemaladie" style={imageStyle} /> 
 <FormulaText>
...
{section >= 2 && (
                <div>
                    ...
                    <img src={"/images/imagesSience/Vac.png"} alt="Vac" style={imageStyle} /> 
       <FormulaText>             
