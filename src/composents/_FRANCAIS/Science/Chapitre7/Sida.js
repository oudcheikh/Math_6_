...
// import Sida1 from '../imagesSience/sida1.png';
// import Sida from '../imagesSience/Sida.png';
// import Virus1 from '../imagesSience/Virus1.png';
// import doctor from '../imagesSience/doctor.png';
// import malade from '../imagesSience/malade.png';
// import vaccination from '../imagesSience/Vaccination.png';
...
const C1 = () => {
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 7 : Le sida et VIH</strong></FormulaText>
                  ...
                  <img src={"/images/imagesSience/Sida.png"} alt="sida" style={imageStyle} /> 
                  <Card>
 ...
 <img src={"/images/imagesSience/Sida1.png"} alt="saida" style={imageStyle} /> 
...
{section >= 2 && (
                <div style={{ marginBottom: '50px', width: '100%' }}>
                    ...
                    <img src={"/images/imagesSience/Virus1.png"} alt="virus" style={imageStyle} /> 
...
<Card>  <FormulaText><strong>Comment savoir si une personne est malade du sida ?</strong></FormulaText>    
                        <img src={"/images/imagesSience/malade.png"} alt="malade" style={imageStyle} /> 
...
<div style={{ display: "flex", alignItems: "center" }}>
  <Audio/>
    ...
    <img src={"/images/imagesSience/vaccination.png"} alt="vaccination" style={imageStyle} /> 
  ...
  <Audio/>
    ...
    <img src={"/images/imagesSience/doctor.png"} alt="doctor" style={imageStyle} /> 
