...
// import Lait from '../imagesSience/Lait.png';
// import teacher from '../imagesSience/Food.png';
// import Healthy from '../imagesSience/HealthyFood.png';
// import glucides from  '../imagesSience/glucides.png';
// import lipidesSource from '../imagesSience/lipides.png';
// import proteines from '../imagesSience/proteines.png';
// import balance from '../imagesSience/balance.png';
// import apple from '../imagesSience/apple.png';
// import man from '../imagesSience/man.png';
...
const C1 = () => {
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 2 : Equilibre Energitique</strong></FormulaText>
                  ...
                  <img src={"/images/imagesSience/man.png.png"} alt="Teacher" style={imageStyle} /> 
                  <Card>
 ...
 <Card>
                        ...
                        <img src={"/images/imagesSience/HealthyFood.png"} alt="Healthy"  style={{ ...imageStyle, width: '220%' }} /> 
...
{section >= 2 && (
                <div>
                    ...
                    <br></br>
                      ...
                      <img src={"/images/imagesSience/balance.png"} alt="balance" style={imageStyle} /> 
  ...
  <Audio/>
    ...
    <img src={"/images/imagesSience/apple.png"} alt="protéines" style={imageStyle} /> 
    <FormulaText>
...
<Card>  <FormulaText><strong>L'importance de consommer suffisamment de calories </strong></FormulaText>    
                        <img src={"/images/imagesSience/glucides.png"} alt="glucides" style={imageStyle} /> 
...
<div style={{ display: "flex", alignItems: "center" }}>
  <Audio/>
    ...
    <img src={"/images/imagesSience/lipides.png"} alt="Sources de lipides" style={imageStyle} /> 
    <FormulaText>
