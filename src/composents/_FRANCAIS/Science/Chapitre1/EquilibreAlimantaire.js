...
const C1 = () => {
    ...
    return (
        <Container>
         <FormulaText><strong>Chapitre 1 : Equilibre Alimantaire</strong></FormulaText>
                  ...
                  <img src={"/images/imagesSience/Food.png"} alt="Food.png" style={imageStyle} /> 
                  <Card>
 ...
 <Card>
                        ...
                        <img src={"/images/imagesSience/HealthyFood.png"} alt="HealthyFood.png"  style={{ ...imageStyle, width: '220%' }} /> 
...
{section >= 2 && (
                <div>
                    ...
                    <br></br>
                      ...
                      <img src={"/images/imagesSience/Lait.png"} alt="Lait" style={imageStyle} /> 
...
<div style={{ display: "flex", alignItems: "center" }}>
  ...
  <Audio/>
    ...
    <img src={"/images/imagesSience/proteines.png"} alt="protéines" style={imageStyle} /> 
    <FormulaText>
        <strong>Viandes :</strong> chameau, mouton, chèvre.<br></br>
